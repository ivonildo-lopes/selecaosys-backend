...
public abstract class BaseDaoImpl<E extends BaseEntity<?>> implements BaseDao<E> {
	...
	private static final long serialVersionUID = 4195028275094795689L;
	...
	@Override
	public long count() {
		return entityManager.createQuery(String.format("SELECT COUNT(*) FROM %s", clazz.getSimpleName()), Long.class)
				.getSingleResult();
	}
